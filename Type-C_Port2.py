# Coding by LiXiao
# Datatime:21/04/16 2:11 PM
# Filename:Type-C_Port2.py
# Toolby: PyCharm
...
dictor = {
    ...
    'ini_dictor': {
        'tycall': ['Port2.ini', 'wmusbel_usbct-all_config.ini'],
        'PHIYO': ['USBPATHport2.INI', 'USBPATH.INI', 'TypeCTester_1605port2.ini', 'TypeCTester_1605.ini']
    },
...
try:
    ...
    for n in range(1, 200):
        ...
        while BOX_TYPE == {}:
            i = os.system("cls")
            print('\n*** TypeC_port2功能测试 ,将Port1和3保持空插 *******')
            print('*** TypeC_port2功能测试 ,将Port1和3保持空插 *******')
            print('*** TypeC_port2功能测试 ,将Port1和3保持空插 *******')
            time.sleep(3)
