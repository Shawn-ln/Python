# Coding by LiXiao
# Datatime:4/27/2021 7:15 PM
# Filename:AutoWebCam.py
# Toolby: PyCharm
...
dictor = {
    ...
    'RUNITEM': 'AutoWebCam',
    'Errorcode': 'MBCF4',
    'tool_path': r'C:\WinTest\FFT\AutoWebCam',
    'instruct': r'AutoWebCam.exe',
    'result_log_name': 'Cameralog.log',
    'check_item': r'Camera Test PASS',
    'check_data': ''
}
support.write_json(
    data=dictor,
    path=r'C:\WinTest\JSON\data',
    filename='AutoWebCam.json'
)
"""
