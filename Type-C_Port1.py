# Coding by LiXiao
# Datatime:21/04/16 8:45 AM
# Filename:Type-C_Port1.py
# Toolby: PyCharm
...
dictor = {
    ...
    'ini_dictor': {
        'tycall': ['Port1.ini', 'wmusbel_usbct-all_config.ini'],
        'PHIYO': ['USBPATHport1.INI', 'USBPATH.INI', 'TypeCTester_1605port1.ini', 'TypeCTester_1605.ini']
    },
...
try:
    ...
    for n in range(1, 200):
        ...
        while BOX_TYPE == {}:
            i = os.system("cls")
            print('\n*** TypeC_port1功能测试 ,将Port2和3保持空插 *******')
            print('*** TypeC_port1功能测试 ,将Port2和3保持空插 *******')
            print('*** TypeC_port1功能测试 ,将Port2和3保持空插 *******')
            time.sleep(3)
